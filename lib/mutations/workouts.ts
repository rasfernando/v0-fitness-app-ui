...
// Mutations for workout templates owned by the user.
//
...
export async function updateWorkoutMetadata(
  ...
  // Build a typed update payload from the supplied fields. Using a typed
  // object (not Record<string, unknown>) keeps the call type-safe under

 ...
 *   1. All completed workout_sessions for the current user, joined with
 ...
 *
 * Returns ProgressData with empty arrays for users with no data yet.
 */
export function useProgressData(): UseProgressDataResult {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      // Query 1: completed sessions for this user
